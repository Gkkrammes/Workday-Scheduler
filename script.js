...
// Append Date and Time to Header 
  $("#currentDay").append();
...
// Change row color based on whether the hour is the past, present, or future hour.
  for (var i = 0; i <= 12; i++) {  
...
// Save entered information to local storage 
